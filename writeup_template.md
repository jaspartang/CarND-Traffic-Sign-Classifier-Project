...
Second step, I normalized the image data because that having a wider distribution in the data would make it more difficult to train using a singlar learning rate. 
As a last step, augment the dataset, this help to impove the accuracy.
